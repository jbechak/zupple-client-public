...
## User Instructions
Zupple has 3 modes: Wordsearch, Crossword, and Sudoku. In each mode, a user can generate puzzles and view them. Logged in users can edit, save, and print puzzles as well. To get started in any of the 3 modes, optionally log in, and then click the mode from the menu bar in the top left area of the browser window. 
